...
import PromptVersions from "../../Admin/Screens/PromptComponents/PromptVersions";
import PromptEditor from "../../Admin/Screens/PromptComponents/PromptEditor";

const UserQuestionsPrompt = () => {
                        ...
                        <div class="nk-block-head nk-page-head">
                            <div class="nk-block-head-between">
                                ...
                                <div>
                                    ...
                                    {showPrompt && <Link className="btn btn-primary ml10" to={`/user/prompt/${ Helpers.encryptString(promptInput.id) }`}><em class="icon ni ni-check-circle"></em> <span className="ml5">Test Prompt</span></Link>}
...
export default UserQuestionsPrompt;
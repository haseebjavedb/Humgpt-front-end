                                    ...
                                    <div class="card-body">
                                        <form onSubmit={handleVerification}>
                                            <div class="row g-1">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit" disabled={isLoading} onClick={handleVerification}>{isLoading ? 'Verifying...' : 'Continue'}</button></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
